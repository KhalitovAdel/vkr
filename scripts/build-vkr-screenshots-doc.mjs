...
const CASE_TITLE = {
  ...
  'Case-05-trip-arrival-not-after-departure-400': 'Кейс 5. Создание рейса: время прибытия не позже времени отправления — отказ (400)',
  'Case-06-vehicle-repair-trip-400': 'Кейс 6. Создание рейса: транспортное средство в ремонте — отказ (400)',
  'Case-07-driver-experience-suburb-400': 'Кейс 7. Создание рейса: пригородный маршрут и недостаточный стаж водителя — отказ (400)',
  'Case-08-trip-vehicle-overlap-400': 'Кейс 8. Создание рейса: пересечение интервалов у того же ТС — отказ (400)',
  'Case-09-waybill-departure-trip-ongoing': 'Кейс 9. Путевой лист: регистрация выезда — статус рейса «На линии» (ONGOING)',
  'Case-10-waybill-return-trip-completed': 'Кейс 10. Путевой лист: регистрация возврата — статус рейса «Завершён» (COMPLETED)',
  'Case-11-waybill-mileage-validation-400': 'Кейс 11. Путевой лист: пробег на возврате меньше пробега на выезде — отказ (400)',
  'Case-12-waybill-return-time-validation-400': 'Кейс 12. Путевой лист: время возврата раньше времени выезда — отказ (400)',
